...
<div align="center">
<img src="./mreccentric01.jpg" width="100" style="border-radius:50%" />
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=2500&pause=800&color=00FF41&center=true&vCenter=true&width=620&lines=We+Don't+Build+Alone.+We+Never+Did.;Real+Code.+Real+People.+Real+Impact.;WoC+%7C+SWoC+%7C+Hacktoberfest+%7C+Always+Open;Fork+it.+PR+it.+Ship+it.+Repeat." alt="Typing SVG" />
...
```bash
$ whoami
> A community of builders who refuse to build in isolation.

$ cat mission.txt
> Transforming learners into contributors, one commit at a time.
> No gatekeeping. No prerequisites. Just build.

$ ls ./what-we-stand-for/
  collaborative-code/   open-source-everything/   learn-by-doing/   ship-real-stuff/
```
